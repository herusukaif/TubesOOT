 ...
 * @version $Id: OOTView.java 723 2010-12-28 14:31:24Z rawcoder $
 */
public class OOTView extends AbstractView {

    private static Preferences prefs = PreferencesUtil.userNodeForPackage(OOTView.class);
    ...
    public OOTView() {
        prefs = PreferencesUtil.userNodeForPackage(OOTView.class);
        initComponents();
        // Init preferences
    ...
    private void initComponents() {
        ...
        caretInfoLabel.setFont(new java.awt.Font("Lucida Grande", 0, 11)); // NOI18N
